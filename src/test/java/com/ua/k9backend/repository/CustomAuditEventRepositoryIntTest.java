package com.ua.k9backend.repository;

import com.ua.k9backend.K9BackendApp;
import com.ua.k9backend.config.Constants;
import com.ua.k9backend.config.audit.AuditEventConverter;
import com.ua.k9backend.domain.PersistentAuditEvent;
...
import static com.ua.k9backend.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
